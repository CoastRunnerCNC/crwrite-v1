...
import {Button, Dialog, DialogTitle, DialogContent, Grid, Select, TextField, Typography, LinearProgress, Tabs, Tab} from '@material-ui/core';
...
const CoastRunnerSVG = (props) => {
    ...
    return (
        <div>
            <svg viewBox="0 31.7412 736 394.1588" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="90.1882" y="41.2706" width="396.424" height="275.718" fill="#F1F2F2"/>
            <rect x="80.6588" y="31.7412" width="19.0588" height="19.0588" fill="#F1F2F2"/>
            <rect x="80.6588" y="31.7412" width="19.0588" height="19.0588" stroke="black" strokeWidth="2.54118"/>
            <rect x="477.082" y="31.7412" width="19.0588" height="19.0588" fill="#F1F2F2"/>
            <rect x="477.082" y="31.7412" width="19.0588" height="19.0588" stroke="black" strokeWidth="2.54118"/>
            <rect x="477.082" y="307.459" width="19.0588" height="19.0588" fill="#F1F2F2"/>
            <rect x="477.082" y="307.459" width="19.0588" height="19.0588" stroke="black" strokeWidth="2.54118"/>
            <rect x="80.6588" y="307.459" width="19.0588" height="19.0588" fill="#F1F2F2"/>
            <rect x="80.6588" y="307.459" width="19.0588" height="19.0588" stroke="black" strokeWidth="2.54118"/>
            <path d="M463.303 76.1546H129.411C128.159 76.1546 127.143 77.17 127.143 78.4226V285.255C127.143 286.508 128.159 287.523 129.411 287.523H463.303C464.555 287.523 465.571 286.508 465.571 285.255V78.4226C465.571 77.17 464.555 76.1546 463.303 76.1546Z" fill="#444444"/>
            <path d="M458.907 70.7355H125.015C123.762 70.7355 122.747 71.7509 122.747 73.0035V279.836C122.747 281.089 123.762 282.104 125.015 282.104H458.907C460.159 282.104 461.175 281.089 461.175 279.836V73.0035C461.175 71.7509 460.159 70.7355 458.907 70.7355Z" fill="#010101"/>
            <path d="M458.907 73.0035H125.015V279.836H458.907V73.0035Z" fill="#010101"/>
            <path d="M116.331 108.173C113.516 108.173 111.229 105.886 111.229 103.072V84.9407C111.229 82.1263 113.516 79.8393 116.331 79.8393C118.332 79.8393 120.066 80.9955 120.898 82.6727H124.259C125.511 82.6727 126.527 83.6892 126.527 84.9407V103.072C126.527 104.324 125.511 105.34 124.259 105.34H120.898C120.06 107.017 118.325 108.173 116.331 108.173Z" fill="#010101"/>
            <path d="M119.164 84.9407C119.164 83.3779 117.893 82.1073 116.331 82.1073C114.768 82.1073 113.497 83.3779 113.497 84.9407V103.072C113.497 104.635 114.768 105.905 116.331 105.905C117.893 105.905 119.164 104.635 119.164 103.072H124.265V84.9407H119.164Z" fill="#010101"/>
            <path d="M458.748 73.0099V279.83H124.863V73.0099H172.808V231.668H410.796V201.924C410.808 201.873 410.808 201.822 410.796 201.771V73.0099H458.748Z" fill="white"/>
            <path d="M119.005 84.9407C119.005 83.3779 117.735 82.1073 116.172 82.1073C114.609 82.1073 113.338 83.3779 113.338 84.9407V103.072C113.338 104.635 114.609 105.905 116.172 105.905C117.735 105.905 119.005 104.635 119.005 103.072H124.107V84.9407H119.005Z" fill="#F19E9F"/>
            <path d="M410.796 73.0099H172.808V231.668H410.796V73.0099Z" fill="#C6C5C5"/>
            <path d="M312.897 94.3812H188.24V105.715H312.897V94.3812Z" fill="#767576"/>
            <path d="M315.762 89.032V114.526H310.095V137.194H298.762V179.695H395.091V89.032H315.762Z" fill="#767576"/>
            <path d="M183.856 76.6883V210.958L174.784 216.199V76.6883H183.856Z" fill="#767576"/>
            <path d="M407.086 221.427V229.68H174.784V221.427L192.274 211.326H389.596L407.086 221.427Z" fill="#767576"/>
            <path d="M407.086 76.6883V216.199L398.02 210.958V76.6883H407.086Z" fill="#767576"/>
            <path d="M360.493 165.718C369.153 165.718 376.172 158.699 376.172 150.039C376.172 141.38 369.153 134.36 360.493 134.36C351.834 134.36 344.814 141.38 344.814 150.039C344.814 158.699 351.834 165.718 360.493 165.718Z" fill="#C6C5C5"/>
            ...
            <rect x="529.153" y="41.2706" width="123.882" height="275.718" fill="#F1F2F2"/>
            <rect x="519.623" y="31.7412" width="19.0588" height="19.0588" fill="#F1F2F2"/>
            <rect x
            <path d="M592.003 273.607V277.247C592.003 278.219 591.64 279.21 591.132 280.202C590.796 280.856 590.395 281.529 590.008 282.177C589.601 282.857 589.195 283.543 588.839 284.236C588.839 284.248 588.839 284.255 588.826 284.261C588.718 284.483 588.616 284.712 588.515 284.934V284.947V281.313C588.515 280.354 588.864 279.376 589.36 278.397C589.703 277.73 590.109 277.05 590.503 276.383C590.91 275.704 591.329 275.011 591.679 274.312C591.793 274.084 591.895 273.855 591.996 273.633C591.996 273.633 591.996 273.62 592.009 273.607H592.003Z" fill="#767576"/>
            <path d="M592.003 271.161C592.003 272.769 590.986 274.458 590.008 276.091C589.709 276.587 589.398 277.108 589.112 277.622C588.705 276.707 588.508 275.926 588.508 275.214C588.508 273.601 589.519 271.917 590.497 270.285C590.802 269.783 591.113 269.268 591.393 268.754C591.806 269.668 592.003 270.45 592.003 271.161Z" fill="#767576"/>
            <path d="M592.003 261.429V265.069C592.003 266.022 591.647 267.006 591.151 267.985C590.815 268.652 590.402 269.332 590.008 269.999C589.468 270.901 588.921 271.822 588.521 272.75C588.521 272.75 588.521 272.762 588.521 272.769V269.135C588.521 268.175 588.871 267.197 589.366 266.219C589.709 265.552 590.116 264.866 590.51 264.205C591.05 263.303 591.602 262.382 591.996 261.454C591.996 261.441 591.996 261.435 592.009 261.429H592.003Z" fill="#767576"/>
            <path d="M592.003 258.983C592.003 260.59 590.986 262.28 590.008 263.906C589.709 264.408 589.398 264.929 589.112 265.444C588.705 264.529 588.508 263.747 588.508 263.036C588.508 261.422 589.519 259.739 590.497 258.106C590.802 257.604 591.113 257.09 591.393 256.575C591.806 257.49 592.003 258.271 592.003 258.983Z" fill="#767576"/>
...
const RunPauseButton = (props) => {
    ...
    <IconButton onClick={handleFeedPause}>
        <div style={circleStyle}>
            <Typography variant="h6" color='secondary'>{paused ? "Run" : "Pause"}</Typography>
        </div>
    </IconButton>
    );
}
...
class Operations extends React.Component {
    ...
    getMillingInProgressDisplay() {
        if (this.props.milling) {
            return (
                <React.Fragment>
                    <Typography display="inline" variant='h4' color="primary">{this.state.millingProgress}%</Typography><RPMDivergence indicatorHeight='30px' />
                    <LinearProgress variant="determinate" color="primary" style={{ height: '5px' }} value={this.state.millingProgress} />
                </React.Fragment>
            );
        }
        return;
    ...
    isOutOfBounds(value) {
        ...
        if (useTempMovementType) {
            ...
            movementTypeAbsolute = this.state.movementType == "absolute" ? true : false;
        }
    ...
    selectGCodeFile() {
        ipcRenderer.once('GCodeFileSelected', (event, gCodeFilePath) => {
            ...
            ipcRenderer.once('File::ResponseGetManualGCodeFileLines', (event, rawGCodes) => {
                console.log(JSON.stringify(rawGCodes));
                this.setState({gCodeFilePath: gCodeFilePath, gCodeFilePathDisplay: gCodeFilePathDisplay, rawGCodes: rawGCodes, currentTab: 1});
            });
    ...
    uploadGCodeFile() {
        ...
        ipcRenderer.once('CNC::UploadGCodeFileResponse', () => {
            this.setState({gCodeFilePath: '', gCodeFilePathDisplay: '', currentTab: 0, timerElapsedSeconds: 0});
        });
    ...
    render() {
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <MenuItem
                                        value="Continuous"
                                        onMouseEnter={(ignored) => component.setState({forceShowJoggingTooltip: true, joggingTooltipText: 'In this mode, CR will move until the arrow click/keystroke ends, or until the axis reaches its end-of-travel.'})}
                                        onMouseLeave={(ignored) => component.setState({forceShowJoggingTooltip: false})}
                                        onClick={(ignored) => {
                                    ...
                                    <MenuItem
                                        value="Fixed"
                                        onMouseEnter={(ignored) => component.setState({forceShowJoggingTooltip: true, joggingTooltipText: 'In this mode, CR will move up to the maximum specified distance per activation (arrow click, keystroke). Motion stops immediately if the keystroke/click ends prior to hitting the maximum specified distance.'})}
                                        onMouseLeave={(ignored) => component.setState({forceShowJoggingTooltip: false})}
                                        onClick={(ignored) => {
                                            component.jogModeRef.current.blur();
                                            component.focusOnNothing();
                                        }}
                                    >Limited (per click)</MenuItem>
                                </Select>
                            </FormControl>
                        </Tooltip>
                    </Grid>
                    ...
                    <FormControl className={component.props.classes.formControl}>
                        <Select
                            ...
                            onChange={(e) => {
                                ...
                                ipcRenderer.send("CNC::ExecuteCommand", e.target.value);
                                component.fetchAsyncData.call(component);
        ...
        function getSvg(component) {
           ...
           C 50.00,135.00 51.00,125.00 51.00,125.00
             ...
             33.27,127.19 46.45,133.87 50.00,135.00 Z"
                             ...
                             tooltipValue={component.getEventKeyFromPathId('y_neg_path')}
           ...
           C 188.00,112.00 187.00,122.00 187.00,122.00
             ...
             204.73,119.81 191.55,113.13 188.00,112.00 Z"
                             clickStarted={component.pathClickStarted}
                             clickEnded={component.pathClickEnded}
                             tooltipValue={component.getEventKeyFromPathId('y_pos_path')}
           ...
           C 252.76,17.95 252.76,39.49 252.76,39.49
             ...
             245.33,18.51 250.60,17.95 252.76,17.95 Z"
                             clickStarted={component.pathClickStarted}
                             clickEnded={component.pathClickEnded}
                             tooltipValue={component.getEventKeyFromPathId('z_pos_path')}
           ...
           C 252.76,65.35 252.76,86.89 252.76,86.89
             ...
             255.64,65.35 252.76,65.35 252.76,65.35 Z"
                             clickStarted={component.pathClickStarted}
                             clickEnded={component.pathClickEnded}
                             tooltipValue={component.getEventKeyFromPathId('z_neg_path')}
           ...
           C 9.36,68.94 9.36,90.48 9.36,90.48
             ...
             12.24,68.94 9.36,68.94 9.36,68.94 Z"
                             clickStarted={component.pathClickStarted}
                             clickEnded={component.pathClickEnded}
                             tooltipValue={component.getEventKeyFromPathId('x_pos_path')}
                             tooltipPlacement={'bottom-start'}/>
           ...
           C 9.36,17.95 9.36,39.49 9.36,39.49
             ...
             1.93,18.51 7.21,17.95 9.36,17.95 Z"
                             clickStarted={component.pathClickStarted}
                             clickEnded={component.pathClickEnded}
                             tooltipValue={component.getEventKeyFromPathId('x_neg_path')}
                ...
                return (
                    <FormControl className={component.props.classes.formControl} fullWidth>
                        ...
                        <Input
                            ...
                            endAdornment={
                                <InputAdornment position="end" style={{alignItems: 'center', height: '100%', margin: '0px'}}>
                                    <IconButton 
                                        style={{padding: '0px'}}
                                        onClick={ () => { 
                                            console.log("disableLimitCatch: " + component.state.settings.disableLimitCatch)
        ...
        return (
            <React.Fragment>
                <ShuttleSettings open={this.state.openShuttleSettings} close={this.closeShuttleSettings} refreshShuttleKeys={this.refreshShuttleKeys} />
                        ...
                        <Grid container spacing={2} direction='column'>
                            <Grid item>
                                <Grid container justify="space-around">
                                    <Grid item xs={8}>
                                        <CoastRunnerSVG component={this} classes={this.props.classes} />
                                    </Grid>
                                    <Grid item xs={4}>
                                        <Grid container direction="column">
                                            <Grid item>
                                                <ItemPanel title="Jog Mode" small>
                                                    <Grid container direction='column' spacing={1} style={{height: '100%', padding: '10px'}}>
                                                        <Grid item>
                                                            <Grid container  style={{alignSelf: 'flex-end'}} direction="column" alignItems='center' spacing={1}>
                                                                {getJoggingMode(this)}
                                                            </Grid>
                                                        </Grid>
                                                        <Grid item>
                                        ...
                                        <Grid container direction='column'>
                                            ...
                                            <Grid item>
                                                <Slider
                                                    ...
                                                    step={2}
                                                    min={30}
                                                    disabled={!this.state.settings.enable_slider}
                            ...
                            <Grid item>
                                <Grid container>
                                        ...
                                        <Grid container spacing={1} direction='column'>
                                            <Grid item>
                                                <Grid container spacing={1} style={{width: "100%"}}>
                                                    <Grid item xs={6}>
                                                        <ItemPanel title="Machine Coordinates" small>
                                                            <Grid container justify='space-evenly' alignItems='center' direction='column' style={{height: '100%', padding: '8px'}}>
                                                                <Grid item>
                                                    ...
                                                    <Grid item xs={6}>
                                                        <ItemPanel title="Work Coordinates" small>
                                                            <Grid container direction='column' justify='space-evenly' alignItems='center' style={{height: '100%', padding: '8px'}}>
                                                                <Grid item>
                                                                    <Grid container alignItems="center" spacing={1}>
                                                                        <Grid item xs={2}>
                                                                            <CustomInputLabel>X</CustomInputLabel>
                                    ...
                                    <Grid item xs={3}>
                                        <Grid container alignItems='center' direction='column' justify='space-evenly' style={{height: '100%'}}>
                                            <Grid item style={{height: '120px', width: '120px'}}>
                                                <RunPauseButton />
                                            </Grid>
                                            <Grid item style={{height: '120px', width: '120px'}}>
                                                <IconButton onClick={this.handleEStop}>
                                                    <StopButton />
                                                </IconButton>
                                            </Grid>
                                        </Grid>
                        ...
                        <Grid container direction='column' spacing={1} style={{height: '100%'}}>
                            <Grid item>
                                <ItemPanel title="Machine Output" small>
                                    <Grid container direction="column" spacing={1} style={{height: '100%', padding: '0px 8px 16px 8px'}}>
                                        <Grid item>
                                            <Grid container alignItems="center">
                                                ...
                                                <Grid item xs={4}>
                                                    <Grid container justify='flex-end' alignItems='flex-end' style={{height: '100%'}}>
                                                        <Grid item>
                                                            <ExportOutput machineOutput={this.state.readWrites} />
                                                        </Grid>
                                                    </Grid>
                                                </Grid>
                                            </Grid>
                                            ...
                                            <Grid container alignItems='center'>
                                                <Grid item xs={1}>
                                                    <Timer 
                                                        ...
                                                        milling={this.props.milling} 
                                                        elapsedSeconds={this.state.timerElapsedSeconds}
                                                        incrementElapsedSeconds={this.incrementElapsedSeconds}
                                                    />
                                                </Grid>
                                                <Grid item xs={11}>
                                    ...
                                    <Input
                                        ...
                                        startAdornment={
                                            <InputAdornment position="start">
                                                <IconButton style={{padding: '0px'}} onClick={this.selectGCodeFile} color="primary">
                                                    <SelectFileIcon />
                                                </IconButton>
                                            </InputAdornment>
                                        }
                                        endAdornment={
                                            <InputAdornment position="end">
                                                <IconButton style={{padding: '0px'}} onClick={this.uploadGCodeFile} color="primary" disabled={!this.state.gCodeFilePath}>
                                                    <ExecuteIcon />
                                                </IconButton>
                                            </InputAdornment>
                                        }
