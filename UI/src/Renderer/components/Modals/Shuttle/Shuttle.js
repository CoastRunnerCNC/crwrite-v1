...
const ManualModeSVG = (props) => {
    return (
        ...
        >
            <path
                d="M42.089 5L23.8696 24.3548L43.3037 45L61.5231 25.6452L42.089 5Z"
                stroke="black"
            />
            <path
                d="M52.4133 23.0645L58.4865 29.5161V37.258H56.0572V35.9677H46.9475L45.7329 34.6774H44.5182L40.8743 30.8064V29.5161L42.089 28.2257V26.9354L45.7329 23.0645H52.4133Z"
                fill="white"
            />
            <path
                d="M42.089 28.2257V26.9354L45.7329 23.0645H52.4133L58.4865 29.5161V37.258H56.0572V35.9677H46.9475L45.7329 34.6774H44.5182L40.8743 30.8064V29.5161M42.089 28.2257H44.5182M42.089 28.2257L40.8743 29.5161M44.5182 28.2257L45.7329 26.9354H46.9475L48.1621 28.2257V29.5161M44.5182 28.2257V29.5161L45.7329 30.8064H46.9475L48.1621 29.5161M48.1621 29.5161H53.628M40.8743 29.5161H37.2304"
                stroke="black"
            />
            <rect
                x="58.4866"
...
class Shuttle extends React.Component {
    ...
    render() {
        ...
        if (
            this.props.status != 2 ||
            this.props.firmware == null ||
            this.props.firmware.grbl == null
        ) {
            if (this.state.open) {
                ...
                {this.props.showOpenIcon ? (
                    ...
                    >
                        <span>
                            <ManualModeSVG
                                disabled={disabled}
                                onClick={this.props.toggleShuttle}
                            />
                        </span>
                    </Tooltip>
                ) : (
                ...
                >
                    <DialogTitle style={{ padding: "0px" }}>
                        <Grid container>
                            ...
                            <Grid item xs={1}>
                                <Button onClick={this.props.toggleShuttle}>
                                    X
                                </Button>
                            </Grid>
                        </Grid>
