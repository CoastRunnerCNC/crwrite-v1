...
class JoggingPanel extends React.Component {
    ...
    jogStart(frontEndCommand, distanceOverride = null) {
    ...
    definedJoggingClicked(e, distance) {
        let pathClass = e.target.className;
        let frontEndCommand = this.pathIdFrontEndCommandMap[pathClass];
        if (frontEndCommand) {
            this.jogStart(frontEndCommand, distance);
        }
    }
