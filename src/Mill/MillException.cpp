...
MillException::MillException(const EMillException t)
	: MillException(t, "")
{

}

MillException::MillException(const EMillException t, const std::string& s)
	: m_type(t),
	m_errorDetail(s),
	m_combinedMessage()
{
...
MillException::EMillException MillException::getType() const
{
	return m_type;
}
